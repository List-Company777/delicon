...
class RankingController extends Controller
{
    public function index()
    {
        ...
        return view('ranking.index', [
            'ranking'   => $ranking,
            'noindex'   => $noindex,
            'pageTitle' => 'デリヘル人気女性ランキング',
            'pageDesc'  => '電話・お気に入り・口コミ・閲覧数から算出したデリヘル人気女性ランキングTOP30。',
    ...
    public function bySlug(string $slug)
    {
        ...
        if ($areaModel) {
            ...
            return view('ranking.index', [
                'ranking'   => $ranking,
                'noindex'   => $noindex,
                'pageTitle' => "{$areaModel->name}のデリヘル人気女性ランキング",
        ...
        return view('ranking.index', [
            'ranking'   => $ranking,
            'noindex'   => $noindex,
            'pageTitle' => "{$prefModel->name}のデリヘル人気女性ランキング",
