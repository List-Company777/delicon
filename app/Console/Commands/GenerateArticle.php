...
class GenerateArticle extends Command
{
    ...
    private const TOPICS = [
        ...
        ['title' => '新宿歌舞伎町のキャバクラ・夜遊びスポット完全ガイド',          'gender' => 'business'],
        ['title' => '初めての夜遊び：キャバクラの料金と楽しみ方',                  'gender' => 'business'],
        ['title' => 'ラウンジとクラブの違い：夜遊びビギナー向け解説',              'gender' => 'business'],
        ['title' => '池袋のキャバクラ・ガールズバー：エリア別おすすめと相場',      'gender' => 'business'],
        ['title' => '渋谷・恵比寿のナイトクラブ・ラウンジガイド',                  'gender' => 'business'],
