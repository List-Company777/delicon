        ...
        <div class="grid sm:grid-cols-2 gap-4 mb-10">
            @php
                $searchTabs = [
                    ...
                    ['icon' => '🟢', 'title' => '待機中',     'desc' => '今すぐ呼べる女性のみを表示。本日出勤中の女性をリアルタイムで確認。'],
        ...
        <div class="grid sm:grid-cols-2 gap-4">
            @php
                $shopFeatures = [
                    ...
                    ['icon' => '✨', 'title' => '新人登録',               'desc' => '新人フラグを立てると新人タブに掲載。入店から30日間は新人バッジが表示されます。'],
                    ['icon' => '📷', 'title' => '写メ日記投稿',           'desc' => '女性ごとに写メ日記を投稿できます。ファン化・リピート促進に効果的です。'],
                    ['icon' => '♡',  'title' => 'お気に入り登録者の分析', 'desc' => '日記投稿画面でファン一覧と遊びやすい曜日・時間帯を確認。出勤計画に活用できます。'],
                    ['icon' => '💬', 'title' => '口コミ管理',             'desc' => '寄せられた口コミを管理画面で確認。不当な書き込みへの削除申請も対応済み。'],
