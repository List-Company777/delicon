...
<div class="max-w-2xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-5">
        <h2 class="font-bold text-gray-800 mb-4">お知らせを追加</h2>
        <form method="POST" action="{{ route('manage.shop.news.store') }}">
            @csrf
            <div class="mb-3">
                <textarea name="body" rows="4" maxlength="1000"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-business-400 @error('body') border-red-400 @enderror"
